...
for i in range(0, len(SDSS['fg']), 1): #len(SDSS['fg'])
    ...
    for x in range(2, len(key_names) + 2, 2):
                ...
                if array[i][x] > 1000. or array[i+1][x] < 1.e-7:
...
np.savetxt('something_new_new.txt', array, header='ID z fu efu fg efg fr efr fh efh f3 ef3 f4 ef4 f5 ef5 f8 ef8 f24 ef24 f70 ef70 f160 ef160 f250 ef250 f350 ef350 f500 ef500 smam esmam', comments='')
